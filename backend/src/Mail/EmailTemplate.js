const NiceEmailTemplate = (text, link) => `
 <!DOCTYPE >
 <html >
 <head>
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   <title>Imran Irshad Protfolio</title>
   <style type="text/css">
   body {
 ...
 <tr>
   ...
   <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                             <div class="contentEditable">
                               <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;'><span class="font">Welcome To Imran Irshad Portfolio</span> </p>
                             </div>
                           </div></td>
 </tr>
</tbody>
                         ...
                         <td align='left'>
                           <div class="contentEditableContainer contentTextEditable">
                             <div class="contentEditable" align='center'>
                               <h2 >You Requested a Password Reset Token</h2>
                             </div>
                           </div>
                         </td>
                       </tr>
                       ...
                       <tr>
                         <td align='left'>
                           <div class="contentEditableContainer contentTextEditable">
                             <div class="contentEditable" align='center'>
                               <p >
                                 Hi There , if you did not request an email reset token Please ignore this email.
                                 <br>
                                 <br>
                                 ...
                                 ${text}
                                 <br>
                                 <span style='color:#222222;'>Imran Irshad</span>
                               </p>
                             </div>
                           </div>
                         </td>
                           ...
                           <table>
                             <tr>
                               <td align='center' bgcolor='#1A54BA' style='background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                 <div class="contentEditableContainer contentTextEditable">
                                   <div class="contentEditable" align='center'>
                                     <a target='_blank' href=${link} class='link2' style='color:#ffffff;'>Reset Your Password</a>
                                   </div>
                                 </div>
                               </td>
                             </tr>
   ...
   <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                   <div class="contentEditable" align='center'>
                                     <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                       <span style='font-weight:bold;'>IIB@WEBDEVS</span>
                                       <br>
                                       imran.ib@live.com
                                       <br>
 ...
 <tr>
   <td valign='top' width='52'>
                                 <div class="contentEditableContainer contentFacebookEditable">
                                   <div class="contentEditable">
                                     <a target='_blank' href="https://www.facebook.com/imran123irshad"><img src="https://findicons.com/files/icons/947/mini_social_networking/64/facebook.png" width='52' height='53' alt='facebook icon' data-default="placeholder" data-max-width="52" data-customIcon="true"></a>
                                   </div>
                                 </div>
                               </td>
   ...
   <td valign='top' width='52'>
                                 <div class="contentEditableContainer contentTwitterEditable">
                                   <div class="contentEditable">
                                     <a target='_blank' href="https://twitter.com/ib_irshad"><img src="https://upload.wikimedia.org/wikipedia/en/9/9f/Twitter_bird_logo_2012.svg" width='52' height='53' alt='twitter icon' data-default="placeholder" data-max-width="52" data-customIcon="true"></a>
                                   </div>
                                 </div>
                               </td>
 </tr>
...
exports.NiceEmailTemplate = NiceEmailTemplate;
